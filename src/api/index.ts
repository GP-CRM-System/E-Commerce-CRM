...
import subscriptionRouter from './subscriptions/subscriptions.router.js';
...
import invitationRouter from './auth/invitation.router.js';
...
import tagRouter from './tags/tags.router.js';
...
router.use('/accept-invitation', invitationRouter);
